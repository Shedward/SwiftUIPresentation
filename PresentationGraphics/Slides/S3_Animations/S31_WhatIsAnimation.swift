...
struct S31_WhatIsAnimation: View, Slide {
    ...
    var episodes: [Episode] {
        ...
        e04(
            ...
            - Давайте посмотрим где у нас все эти параметры появляются в SwiftUI
            - Обычно все начинают с показа модификаторов для обычных юзкейсов а потом переходят к кишкам
            - Но давайте вместе этого пойдем с обратного конца и соберем анимацию вручную
            """
        )
    }
