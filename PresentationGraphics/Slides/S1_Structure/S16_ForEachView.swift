...
struct S16_ForEachView: View, Slide {
    ...
    var notes: String? {
        ...
        e01 - ForEach подразумевает динамическое дерево, элементы которого напрямую зависят
            - от модели к которой ForEach привязан
            ...
            - И перед тем как говорить про идентификаторы, давайте на секунду вернемся к вопросу что такое ViewBuilder
            [следующий слайд]
        """
    }
